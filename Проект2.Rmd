...
Импортируем данные:
```{r}
df<- dirname(rstudioapi::getSourceEditorContext()$path)
setwd("C:/Users/Ярослав/OneDrive/Рабочий стол/Учеба/Институт биоинформатики/Статистика и R/Проект 2")
df <- read.csv("soybean.csv", header= TRUE , stringsAsFactors= FALSE )
```
